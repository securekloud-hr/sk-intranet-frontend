...
/* ------------ Admin TEAM DAAdmin (for Admin Details Adminb) ------------ */
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Providing the infrastructure and support for you and your team to perform at your best!
        </p>
      </div>

      {/* Tabs wrapper */}
      <Tabs defaultValue="keyinfo" className="space-y-6">
        <TabsList className="grid w-full max-w-md grid-cols-3">
          <TabsTrigger value="keyinfo">Key Information</TabsTrigger>
          <TabsTrigger value="details">Admin Team</TabsTrigger>
        </TabsList>

        {/* 1️⃣ Referral Program tab */}
        <TabsContent value="keyinfo" className="space-y-6">
